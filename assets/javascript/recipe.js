function recipeData() {
    ...
    $.ajax({
        ...
        for (i = 0; i < response.hits.length; i++) {
            ...
            var leftCol = $('<div class="col-md-4" id="recipeImg">').appendTo(row1);
            var rightCol = $('<div class="col-md-8 px-3">').appendTo(row1);
            var decsription = $('<div class="recipeDetails">').appendTo(rightCol);
            ...
            var ingDecsription = $('<div class="recipeIngredient">').appendTo(col);
